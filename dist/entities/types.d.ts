...
export interface ObjectPlacement {
    /**
     * Stable identifier, independent of position. Required to move the
     * placement at runtime via `game.dungeon.moveObject(id, x, z)` — without
     * it the renderer keys the object by its type+position, so a position
     * change is indistinguishable from "old one removed, new one placed" and
     * snaps instead of gliding. Auto-generated by `place.billboard()` when
     * omitted.
     */
    id?: string;
