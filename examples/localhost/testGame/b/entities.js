...
function spiderSpriteMap() {
	return {
		defaults: {
			...
			inv: [],
			invimg: null,
			STR: 10, DEX: 10, VIT: 10, WIS: 10, CHR: 10,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/spider1top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
...
function statueSpriteMap() {
	return {
		...
		layers: [
			...
			{ tile: "creatures/statue1base", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
function skywhaleSpriteMap() {
	return {
		...
		layers: [
			{ tile: "creatures/skywhale", opacity: 1.0, bob: { amplitudeY: 0.03, speed: 2 }, },
		],
	};
}
function doomDryadSpriteMap() {
	return {
		...
		layers: [
			{ tile: "creatures/doomdryad", opacity: 1.0, bob: { amplitudeY: 0.03, speed: 2 }, },
		],
	};
}
...
function centriciaSpriteMap() {
	return {
		...
		layers: [
			...
			{ tile: "creatures/centricia64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function tereniaSpriteMap() {
	return {
		defaults: {
			...
			class: "Dancer", race: "Elvine,Forest",
			about: `<p></p>`,
			inv: ["katana", ""],
			gp: 0,
			invimg: "ui/terenia_inv",
			thumbimg: "ui/thumb_terenia",
			STR: 16, DEX: 15, VIT: 10, WIS: 8, CHR: 11,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/terenia64base", opacity: 1.0 },
			{ tile: "creatures/terenia64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function miaSpriteMap() {
	return {
		defaults: {
			name: "Mia Frostcoral",
			class: "Ranger", race: "Devakin,Devakin",
			about: `<p></p>`,
			inv: ["arquebus", ""],
			gp: 0,
			invimg: "ui/mia_inv",
			thumbimg: "ui/thumb_mia",
			STR: 11, DEX: 15, VIT: 10, WIS: 14, CHR: 10,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/mia64base", opacity: 1.0 },
			{ tile: "creatures/mia64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function ridynSpriteMap() {
	return {
		defaults: {
			name: "Ridyn",
			class: "Assassin", race: "Changeling",
			about: `<p></p>`,
			inv: ["dagger", "dagger"],
			gp: 0,
			invimg: "ui/ridyn_inv",
			thumbimg: "ui/thumb_ridyn",
			STR: 13, DEX: 13, VIT: 10, WIS: 13, CHR: 11,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/ridyn64base", opacity: 1.0 },
			{ tile: "creatures/ridyn64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function kagamiSpriteMap() {
	return {
		defaults: {
			name: "Kagami",
			class: "Fighter", race: "Demi-Human,Inumimi",
			about: `<p></p>`,
			inv: ["ribbon", ""],
			gp: 0,
			invimg: "ui/kagami_inv",
			thumbimg: "ui/thumb_kagami",
			STR: 14, DEX: 11, VIT: 9, WIS: 12, CHR: 14,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/kagami64base", opacity: 1.0 },
			{ tile: "creatures/kagami64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function momoSpriteMap() {
	return {
		defaults: {
			name: "Momo Ohana",
			class: "Artificer", race: "Human,Human",
			about: `<p></p>`,
			inv: ["wrench", ""],
			gp: 0,
			invimg: "ui/momo_inv",
			thumbimg: "ui/thumb_momo",
			STR: 12, DEX: 9, VIT: 13, WIS: 15, CHR: 11,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/momo64base", opacity: 1.0 },
			{ tile: "creatures/momo64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function bakulSpriteMap() {
	return {
		defaults: {
			...
			class: "Paladin", race: "Draconix,Draconix",
			about: `<p></p>`,
			inv: ["longsword", ""],
			gp: 0,
			invimg: "ui/bakul_inv",
			thumbimg: "ui/thumb_bakul",
			STR: 15, DEX: 12, VIT: 12, WIS: 11, CHR: 10,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/bakul64base", opacity: 1.0 },
			{ tile: "creatures/bakul64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
function jonasSpriteMap() {
	return {
		defaults: {
			name: "Jonas Treboy",
			class: "Bard", race: "Mechamilite,Doll",
			about: `<p></p>`,
			inv: ["fist", ""],
			gp: 0,
			invimg: "ui/jonas_inv",
			thumbimg: "ui/thumb_jonas",
			STR: 8, DEX: 14, VIT: 10, WIS: 14, CHR: 14,
		},

		frameSize: { w: 64, h: 64 },
		layers: [
			{ tile: "creatures/jonas64base", opacity: 1.0 },
			{ tile: "creatures/jonas64top", opacity: 1.0, bob: { amplitudeY: -0.015, speed: 2 }, },
		],
	};
}
...
export function spawnParty(ply1) {
	for (let i = 1; i < 4; i++) {
		const partymember = createEntity({
			...
			x: ply1.x, z: ply1.z,
			alive: true, speed: 6,
			maxHp: 28,hp: 20, attack: 2, defense: 1,
		});
